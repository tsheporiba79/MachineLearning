...
def beam_search_decode(
    ...
    Args:
        ...
        source_mask (torch.Tensor): The mask for the source input.
        tokenizer_source: The source tokenizer.
        tokenizer_target: The target tokenizer.
...
def run_validation(
    ...
    Args:
        ...
        max_len (int): The maximum length of the sequence.
        device (torch.device): The device to run the computation on.
        print_msg: The function to print messages.
        num_examples (int, optional): The number of examples to evaluate. Defaults to 2.
    """
    model.eval()
    count = 0
